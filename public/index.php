...
$router->map( 'GET', '/agenda', 'AgendaController#agenda', 'agenda' );
$router->map( 'GET', '/blog', 'BlogController#BlogOverview', 'blog' );
$router->map( 'GET', '/view-blog/blogpost/[i:id]', 'BlogController#view', 'view-blog' );
$router->map( 'GET', '/about-us', 'PageController#aboutUs', 'aboutUs' );
$router->map( 'GET', '/contact', 'PageController#aboutUs', 'contact' );
// Ajax Voorbeeld
